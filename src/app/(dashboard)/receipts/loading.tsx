    ...
    <div className="invo-loading-delay space-y-6" role="status" aria-live="polite" aria-busy="true">
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-2">
          ...
          <div className="h-4 w-64 max-w-[70vw] rounded-md bg-muted/70 animate-pulse" aria-hidden="true" />
        </div>
        <div className="h-10 w-36 rounded-md bg-muted/70 animate-pulse" aria-hidden="true" />
      </div>

      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="h-10 w-full rounded-md bg-muted/70 animate-pulse sm:max-w-sm" aria-hidden="true" />
        <div className="flex gap-2">
          <div className="h-10 w-28 rounded-md bg-muted/70 animate-pulse" aria-hidden="true" />
          <div className="h-10 w-28 rounded-md bg-muted/70 animate-pulse" aria-hidden="true" />
        </div>
      </div>
