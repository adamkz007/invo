    ...
    <div className="invo-loading-delay space-y-6" role="status" aria-live="polite" aria-busy="true">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <div className="rounded-lg border p-4 space-y-4">
          <div className="h-5 w-48 rounded-md bg-muted/70 animate-pulse" aria-hidden="true" />
          <div className="h-9 w-full rounded-md bg-muted/70 animate-pulse" aria-hidden="true" />
          <div className="h-9 w-full rounded-md bg-muted/70 animate-pulse" aria-hidden="true" />
          <div className="h-9 w-full rounded-md bg-muted/70 animate-pulse" aria-hidden="true" />
        </div>
        <div className="rounded-lg border p-4 space-y-4">
          <div className="h-5 w-56 rounded-md bg-muted/70 animate-pulse" aria-hidden="true" />
          <div className="h-9 w-full rounded-md bg-muted/70 animate-pulse" aria-hidden="true" />
          <div className="h-9 w-full rounded-md bg-muted/70 animate-pulse" aria-hidden="true" />
          <div className="h-9 w-full rounded-md bg-muted/70 animate-pulse" aria-hidden="true" />
        </div>
